...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VotaInteligenteMessage.fbshared'
        db.add_column(u'elections_votainteligentemessage', 'fbshared',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VotaInteligenteMessage.fbshared'
        db.delete_column(u'elections_votainteligentemessage', 'fbshared')
