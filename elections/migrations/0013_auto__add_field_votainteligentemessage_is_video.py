...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VotaInteligenteMessage.is_video'
        db.add_column(u'elections_votainteligentemessage', 'is_video',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VotaInteligenteMessage.is_video'
        db.delete_column(u'elections_votainteligentemessage', 'is_video')
